...
(function () {
    ...
    function activeClass(page) {
        ...
        if (page === 'platform' && path.indexOf('/platform') !== -1) return ' nav-active';
        if (page === 'solutions' && path.indexOf('/solutions') !== -1) return ' nav-active';
    ...
    var navHTML = [
        ...
        '    <li><a href="/platform/" class="nav-link' + activeClass('platform') + '">Platform</a></li>',
        '    <li><a href="/solutions/" class="nav-link' + activeClass('solutions') + '">Solutions</a></li>',
